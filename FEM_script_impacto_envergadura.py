...
velocidad_l= [ 41.11111111,  46.74603175,  52.38095238,  58.01587302,
        63.65079365,  69.28571429,  74.92063492,  80.55555556,
        86.19047619,  91.82539683,  97.46031746, 103.0952381 ,
       108.73015873, 114.36507937, 120.        ]
desplazamiento_pajaro=[0.  , 0.06, 0.12, 0.18, 0.24, 0.3 ]
def modelo_completo(indice):
    ...
    desplazamiento=desplazamiento_pajaro[indice]
    ...
    a1.translate(instanceList=('Bird-1', ), vector=(0.0, 0.0, desplazamiento))
...
for i in range(0,len(desplazamiento_pajaro)):
    modelo_completo(i)
